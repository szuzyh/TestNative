...
public class FaceSetOperate {
    ...
    public byte[] addFaceByFaceToken(String faceTokens, String faceSetToken) throws Exception {
        ...
        map.put(http.Key.KEY_FOR_FACE_TOKENS, faceTokens);
        map.put(http.Key.KEY_FOR_FACESET_TOKEN, faceSetToken);
        return http.HttpRequest.post(url, map);
    }
    ...
    public byte[] addFaceByOuterId(String FaceTokens, String outerId) throws Exception {
        String url =http.Key.WEB_BASE +http.Key.SPLIT + http.Key.FACESET + http.Key.SPLIT +http.Key.ADD;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_FACE_TOKENS, FaceTokens);
        map.put(http.Key.KEY_FOR_OUTER_ID, outerId);
        return http.HttpRequest.post(url, map);
    }
    ...
    public byte[] createFaceSet(String displayName, String outerId, String tags, String FaceTokens, String userData, int ForceMerge) throws Exception {
        String url =http.Key.WEB_BASE + http.Key.SPLIT +http.Key.FACESET + http.Key.SPLIT +http.Key.CREATE;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        if(!(displayName=="")){
        ...
        if(!(tags=="")){
            map.put(http.Key.KEY_FOR_TAGS, tags);
        }
        if(!(FaceTokens=="")){
    ...
    public byte[] deleteFaceSetByToken(String faceSetToken, int checkEmpty) throws Exception {
        String url = http.Key.WEB_BASE + http.Key.SPLIT +http.Key.FACESET +http.Key.SPLIT +http.Key.DELETE;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_FACESET_TOKEN, faceSetToken);
        map.put(http.Key.KEY_FOR_CHECK_EMPTY, String.valueOf(checkEmpty));
        return http.HttpRequest.post(url, map);
    }
    ...
    public byte[] deleteFaceSetByOuterId(String outerId, int checkEmpty) throws Exception {
        String url = Key.WEB_BASE + http.Key.SPLIT + http.Key.FACESET + http.Key.SPLIT +http.Key.DELETE;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_OUTER_ID, outerId);
    ...
    public byte[] getDetailByFaceToken(String faceSetToken) throws Exception {
        String url = http.Key.WEB_BASE + http.Key.SPLIT + http.Key.FACESET + http.Key.SPLIT +http.Key.GET_DETAIL;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_FACESET_TOKEN, faceSetToken);
    ...
    public byte[] removeFaceFromFaceSetByFaceSetToken(String faceSetToken, String faceTokens) throws Exception {
        String url = http.Key.WEB_BASE + http.Key.SPLIT +http.Key.FACESET + http.Key.SPLIT + http.Key.REMOVE_FACE;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_FACESET_TOKEN, faceSetToken);
    ...
    public byte[] getFaceSets(String tags) throws Exception {
        String url = http.Key.WEB_BASE + http.Key.SPLIT +http.Key.FACESET + http.Key.SPLIT + http.Key.GET_FACESETS;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_TAGS, tags);
    ...
    public byte[] updateFaceSetByFaceSetToken(String faceSetToken, String newOuterId, String displayName, String userData, String tags) throws Exception {
        String url = http.Key.WEB_BASE + http.Key.SPLIT + http.Key.FACESET + http.Key.SPLIT + http.Key.UPDATE;
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(http.Key.KEY_FOR_APIKEY, apiKey);
        map.put(http.Key.KEY_FOR_APISECRET, apiSecret);
        map.put(http.Key.KEY_FOR_FACESET_TOKEN, faceSetToken);
        map.put(http.Key.KEY_FOR_NEW_OUTER_ID, newOuterId);
        map.put(http.Key.KEY_FOR_DISPLAY_NAME, displayName);
        map.put(http.Key.KEY_FOR_USER_DATA, userData);
        map.put(http.Key.KEY_FOR_TAGS, tags);
        return http.HttpRequest.post(url, map);
    }
